! gfortran create_jedi_specparm.f95 -o create_jedi_specparm.x
...
!
!  Get the output filename, output_filenmae
!
  if ( 4 <= arg_num ) then
    iarg = 4
    call getarg ( iarg, output_filename )
  else
    output_filename = 'jedi_specparms.txt'
  end if
...
!
  ...
  call r8mat_write ( output_filename, 20, n, c )

  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) &
    '  The Latin Random Square data was written to the file "' &
...
!    write ( string, '(a1,i8,a1,i8,a1,i8,a1)' ) '(', m, 'g', 24, '.', 16, ')'
    write ( string, '(a1,i8,a1,i8,a1,i8,a1)' ) '(', m, 'f', 6, '.', 3, ')'
!
!  Write the data.
!
    do j = 1, n
